  ...
  for i = 1:size([u, v], 1)
      ...
      if u(i) > v(i)
          ...
          elseif strcmp(TransName, 'MHSwendsenWang2')
              ...
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              assignments = repmat((1:G.card(u(i)))', 1, 2);
              %lf = length(edge_factor.var);
              %assignments = repmat((1:length(edge_factor.card(1))', 1, lf);
              indxs = AssignmentToIndex(assignments, edge_factor.card);
              q_ij = sum(edge_factor.val(indxs)) / sum(edge_factor.val);
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          else
